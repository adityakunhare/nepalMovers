                    ...
                    <div class="card-body box-profile">
                        <div class="text-center">
                            <img class="profile-user-img img-fluid img-circle"
                                src="{{!empty($user->image) ? asset('upload/admin/'.$user->image) : asset('img/user4-128x128.jpg')}}"
                ...
                <div class="card">
                    <div class="card-header p-2">
                        <ul class="nav nav-pills">
                            ...
                            <li class="nav-item" ><a id="password_tab" class="nav-link" href="#change_password" data-toggle="tab">Change Password</a>
                            </li>
                        </ul>
                    </div><!-- /.card-header -->
                    <div class="card-body">
                        <div class="tab-content">
                            ...
                            <div class="tab-pane"  id="change_password">
                                <form class="form-horizontal" action="{{route('admin.user.update-password')}}" method="post">
                                    @csrf
                                    <div class="form-group row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="password" class="form-control {{ $errors->has('confirm_password') ? 'is-invalid' : ''}}" id="confirm password" name="confirm_password" placeholder="confirm Password">
                                            <b class="text-red">{{$errors->first('confirm_password') }}</b>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="offset-sm-2 col-sm-10">
